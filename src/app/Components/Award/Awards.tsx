    ...
    return (
        ...
        <div className="container">
          <div className="cs_section_heading cs_style_1">
            <p className="cs_section_subtitle cs_fs-18 cs_semibold cs_accent_color cs_mb_20 wow fadeInDown">Awards & Recognition<span className="cs_shape_right"></span>
            </p>
            <h2 className="cs_fs_48 mb-0 wow fadeInUp">Check our awards & <br/> achievements</h2>
          </div>
              ...
              <div className="cs_iconbox cs_style_2">
                <div className="cs_image_layer cs_style_1">
                  <div className="cs_image_layer_in cs_radius_20">
                    <Image src="/assets/img/award_1.jpg" alt="img" width={331} height={366}   />
                  </div>
                </div>
                <Link href="/service/service-details" aria-label="Click to view service" className="cs_iconbox_icon cs_center cs_radius_50">
                ...
                <div className="cs_iconbox_content">
                  <p className="cs_medium cs_mb_15">MARCH 26, 2024</p>
                  <h2 className="cs_iconbox_title cs_fs_24 cs_semibold mb-0"><Link href="/service/service-details" aria-label="Click to view service">Digital agency bring specialized</Link></h2>
                </div>
              </div>
            </div>
          ...
          <div className="cs_award_shape_2 position-absolute">
            <Image src="/assets/img/award_shape_1.svg" alt="img" width={381} height={1184}   />
          </div>
        </div>
        <div className="cs_height_120 cs_height_lg_80"></div>
      </section>
